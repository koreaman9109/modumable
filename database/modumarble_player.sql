...
CREATE TABLE `player` (
  ...
  `player_money` int(11) DEFAULT '500000',
  `player_win` int(11) DEFAULT '0',
  `player_lose` int(11) DEFAULT '0',
  `player_location` int(11) DEFAULT '0',
  `player_turn` int(11) DEFAULT '0',
...
INSERT INTO `player` VALUES ('player1','123',900000,6,3,8,0),('zcomputer','123',900000,1,3,8,1);
